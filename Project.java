...
public class Project extends JFrame implements ActionListener{
    String meter1,nameU;
    Project(String meter, String person , String name){
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Customer Details")){
            ...
            new PayBill(meter1).setVisible(true);
            ...
            new GenerateBill(meter1).setVisible(true);
            
        }else if(msg.equals("Deposit Details")){
            new DepositDetails().setVisible(true);
        }else if(msg.equals("View Information")){
            new ViewInformation(meter1).setVisible(true);
        }else if(msg.equals("Update Information")){
            new UpdateInformation(meter1,nameU).setVisible(true);
        }else if(msg.equals("Bill Details")){
            new BillDetails(meter1).setVisible(true);
        }
